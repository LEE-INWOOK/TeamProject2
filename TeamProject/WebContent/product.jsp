...
<input class="custom-control-input" id="customRadio2" type="radio" name="product_color">
<label class="custom-control-label" for="customRadio2">빨강</label>
</div>
</div>
</div>
...
<div class="col-sm-10">
<div class="custom-control custom-radio">
<input class="custom-control-input" id="customRadio2" type="radio" name="product_size">
<label class="custom-control-label" for="customRadio2">빨강</label>
</div>
</div>
</div>
...
<div class="col-sm-10">
<div class="custom-control custom-radio">
<input class="custom-control-input" id="customRadio2" type="radio" name="product_category">
<label class="custom-control-label" for="customRadio2">빨강</label>
</div>
</div>
</div>
...
<label class="col-sm-2 col-form-label" for="inputEmail3">배송정보</label>
 <div class="col-sm-10">
<input class="form-control" id="inputEmail3" type="text" name="product_detail_del_info" placeholder="상품명">
 </div>
</div>
...
<label class="col-sm-2 col-form-label" for="inputEmail3">할인</label>
 <div class="col-sm-10">
<input class="form-control" id="inputEmail3" type="text" name="product_detail_sale" placeholder="상품명">
 </div>
</div>

<div class="form-group row">
<label class="col-sm-2 col-form-label" for="inputEmail3">상세정보 date?</label>
 <div class="col-sm-10">
<input class="form-control" id="inputEmail3" type="text" placeholder="상품명">
 </div>
</div>
